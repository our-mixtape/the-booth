...
- **Video (60 s):** [Hosted demonstration](docs/evidence/hosted-gateway/booth-hosted-demo-60s.mp4) — real deployed Astra session with verified system audio. [Earlier local video](https://raw.githubusercontent.com/our-mixtape/the-booth/a8407dad5c86d1b6b1be807576ea132305449143/docs/evidence/hosted-gateway/booth-demo-60s.mp4) and [verification](docs/evidence/hosted-gateway/README.md) are preserved.
